...
import { addCircleOutline, chevronDownCircleOutline, createOutline, trash } from "ionicons/icons";
  ...
  return (
    <IonPage>
      ...
      <IonContent>
        ...
        <p>Arrastra para actualizar estadisticas...</p>
          <> 
